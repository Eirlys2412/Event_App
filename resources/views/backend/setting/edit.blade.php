                ...
                <div class="intro-y box p-5">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="px-4 pb-4 mt-5 flex items-center  cursor-pointer relative">
                            <div data-single="true" id="mylogo" class="dropzone  "    url="{{route('admin.upload.avatar')}}" >
                    ...
                    <div class="mt-3">
                        ...
                        <div class="px-4 pb-4 mt-5 flex items-center  cursor-pointer relative">
                            <div data-single="true" id="mymap" class="dropzone  "    url="{{route('admin.upload.avatar')}}" >
                                <div class="fallback"> <input name="file" type="file" /> </div>
                                <div class="dz-message" data-dz-message>
                                    <div class=" font-medium">Kéo thả hoặc chọn ảnh.</div>
...
<script>
    ...
    Dropzone.instances[1].options.maxFilesize =  50; // MB
    Dropzone.instances[1].options.maxFiles =50;
    ...
    Dropzone.instances[2].options.maxFilesize =  50; // MB
    Dropzone.instances[2].options.maxFiles =50;
