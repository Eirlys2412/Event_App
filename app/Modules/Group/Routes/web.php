...
Route::prefix('admin/groupmembers')->group(function () {
    ...
    Route::get('/{groupId}/edit/{id}', 'GroupMemberController@edit')->name('admin.groupmember.edit');
    Route::patch('/{id}', [GroupMemberController::class, 'update'])->name('admin.groupmember.update'); // Cập nhật thành viên
