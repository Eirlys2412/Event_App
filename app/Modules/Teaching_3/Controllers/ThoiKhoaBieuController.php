...
class ThoiKhoaBieuController extends Controller
{
    ...
    public function index()
    {
        ...
        $hocphan  = HocPhan::all();
        $tags = Tag::all();
        $tag_diadiem = TagDiadiem::all();

        return view('Teaching_3::thoikhoabieu.index', compact('tag_diadiem','tags','hocphan','teacher','thoikhoabieu','breadcrumb', 'active_menu'));
    }
    ...
    public function create()
    {
        ...
        $hocphan  = HocPhan::all();
        // $diadiem = DiaDiem::all();
        return view('Teaching_3::thoikhoabieu.create', compact('tags','hocphan','teacher','phancong','breadcrumb', 'active_menu'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $tagservice->store_diadiem_tag($thoikhoabieu->id,$tag_ids);
    ...
    public function edit($id){
        ...
        $hocphan  = HocPhan::all();
        $thoikhoabieu = ThoiKhoaBieu::findOrFail($id);
        return view('Teaching_3::thoikhoabieu.edit', compact('tags','thoikhoabieu','hocphan','teacher','phancong','breadcrumb', 'active_menu'));
    }
    public function update(Request $request, $id){
       ...
       $request->validate([
        ...
        $tagservice = new \App\Http\Controllers\TagController();
        $tag_ids = $request->tag_ids;
        $tagservice->update_diadiem_tag($thoikhoabieu->id,$tag_ids);
