...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{route('admin.thoikhoabieu.create')}}" class="btn btn-primary shadow-md mr-2">Thêm thời khóa biểu</a>
            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        <th class="whitespace-nowrap">ĐẦU TIẾT</th>
                        <th class="whitespace-nowrap">CUỐI TIẾT</th>
                ...
                <tbody>
                    ...
                    <tr class="intro-x">
                        ...
                        <td>
                            <p target="_blank" href="" class="font-medium whitespace-nowrap">{{ ($item->ngay) }}</p> 
                        </td>
                        <td>
                            <p target="_blank" href="" class="font-medium whitespace-nowrap">{{ ($item->tietdau) }}</p> 
                        </td>
                        <td>
                            <p target="_blank" href="" class="font-medium whitespace-nowrap">{{ ($item->tietcuoi) }}</p> 
                        </td>
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a href="{{route('admin.thoikhoabieu.edit',$item->id)}}" class="flex items-center mr-3" href="javascript:;"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
                                <form action="{{route('admin.thoikhoabieu.destroy',$item->id)}}" method = "post">
                                    @csrf
                                    @method('DELETE')
