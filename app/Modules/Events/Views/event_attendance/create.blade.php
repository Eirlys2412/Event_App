...
<div class="grid grid-cols-12 gap-12 mt-5">
    <div class="intro-y col-span-12 lg:col-span-12">
        <!-- BEGIN: Form Layout -->
        <form method="post" action="{{ route('admin.event_attendance.store') }}">
            @csrf
            <div class="intro-y box p-5">
                ...
                <div class="mt-3">
                    ...
                    <select id="user_id" name="user_id[]" class="form-control @error('user_id') is-invalid @enderror" multiple required>
