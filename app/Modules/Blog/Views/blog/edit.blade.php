            ...
            <form method="post" action="{{route('admin.blog.update',$blog->id)}}" enctype="multipart/form-data">
                ...
                <div class="intro-y box p-5">
                    <div>
                        ...
                        <input id="title" name="title" type="text" value="{{$blog->title}}" class="form-control" placeholder="title" required>
                    </div>
                    <div class="mt-3">
                        ...
                        <div class="flex flex-col sm:flex-row items-center">
                            ...
                            <option value =""> - Chọn danh mục - </option>
                                @foreach($categories as $cat)
                                    <option value ="{{$cat->id}}" {{$cat->id == $blog->cat_id?'selected':''}}> {{ $cat->title}} </option>
                                @endforeach
                            </select>
                        </div>
                    </div>
